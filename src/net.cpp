...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "audium " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"audiumtools.com", "dnsseed.audiumtools.com"},
    {"audiumpool.org", "dnsseed.audiumpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"audiumtools.com", "testnet-seed.audiumtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. audium is probably already running."), addrBind.ToString().c_str());
        else
